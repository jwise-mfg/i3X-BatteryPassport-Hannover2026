...
from .aas.aas_data_source import AASDataSource
...
class DataSourceFactory:
    ...
    def _create_single_source(data_source_type: str, data_source_config: Dict[str, Any]) -> I3XDataSource:
        ...
        elif data_source_type == "aas":
            return AASDataSource(data_source_config)
        else:
    ...
    def get_supported_types() -> list:
        ...
        return ["mock", "mqtt", "cnc-mock", "ignition-cnc", "aas"]